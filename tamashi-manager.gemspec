...
Gem::Specification.new do |spec|
  spec.name          = "tamashi-manager"
  spec.version       = Tamashi::Manager::VERSION
  ...
  spec.homepage      = "https://github.com/lctseng/tamashi-manager"
  ...
  spec.add_runtime_dependency "tamashi-common"
